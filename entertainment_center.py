...
kings_speech = media.Movie ("King's Speech",
	"England's Prince Albert must ascend the throne as King George VI, but he has a speech impediment.",
...
the_rock = media.Movie ("The Rock",
	"FBI chemical warfare expert is sent on an urgent mission with a former British spy",
...
private_ryan = media.Movie ("Saving Private Ryan",
	...
	"http://t2.gstatic.com/images?q=tbn:ANd9GcR0lDhR_dXAKTm9wysp3nWu6kP0V5skJBVbCNC_Q8urAWcr4iF_",
